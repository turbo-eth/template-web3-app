// Generated by @wagmi/cli@0.1.11 on 4/3/2023 at 6:38:58 AM
import {
  useContract,
  UseContractConfig,
  useContractRead,
 ...
 */
export function useErc20Balances<TSelectData = ReadContractResult<typeof erc20ABI, 'balances'>>(
  config: Omit<UseContractReadConfig<typeof erc20ABI, 'balances', TSelectData>, 'abi' | 'functionName'> = {} as any
) {
  return useContractRead({ abi: erc20ABI, functionName: 'balances', ...config } as UseContractReadConfig<typeof erc20ABI, 'balances', TSelectData>)
}
 ...
 */
export function useErc20Allowed<TSelectData = ReadContractResult<typeof erc20ABI, 'allowed'>>(
  config: Omit<UseContractReadConfig<typeof erc20ABI, 'allowed', TSelectData>, 'abi' | 'functionName'> = {} as any
) {
  return useContractRead({ abi: erc20ABI, functionName: 'allowed', ...config } as UseContractReadConfig<typeof erc20ABI, 'allowed', TSelectData>)
}
 ...
 */
export function useErc20Mintable(config: Omit<UseContractConfig, 'abi'> = {} as any) {
 ...
 */
export function useErc20MintableAllowance<TSelectData = ReadContractResult<typeof erc20MintableABI, 'allowance'>>(
  config: Omit<UseContractReadConfig<typeof erc20MintableABI, 'allowance', TSelectData>, 'abi' | 'functionName'> = {} as any
) {
 ...
 */
export function useErc20MintableBalanceOf<TSelectData = ReadContractResult<typeof erc20MintableABI, 'balanceOf'>>(
  config: Omit<UseContractReadConfig<typeof erc20MintableABI, 'balanceOf', TSelectData>, 'abi' | 'functionName'> = {} as any
) {
 ...
 */
export function useErc20MintableDecimals<TSelectData = ReadContractResult<typeof erc20MintableABI, 'decimals'>>(
  config: Omit<UseContractReadConfig<typeof erc20MintableABI, 'decimals', TSelectData>, 'abi' | 'functionName'> = {} as any
) {
 ...
 */
export function useErc20MintableName<TSelectData = ReadContractResult<typeof erc20MintableABI, 'name'>>(
  config: Omit<UseContractReadConfig<typeof erc20MintableABI, 'name', TSelectData>, 'abi' | 'functionName'> = {} as any
) {
 ...
 */
export function useErc20MintableSymbol<TSelectData = ReadContractResult<typeof erc20MintableABI, 'symbol'>>(
  config: Omit<UseContractReadConfig<typeof erc20MintableABI, 'symbol', TSelectData>, 'abi' | 'functionName'> = {} as any
) {
 ...
 */
export function useErc20MintableTotalSupply<TSelectData = ReadContractResult<typeof erc20MintableABI, 'totalSupply'>>(
  config: Omit<UseContractReadConfig<typeof erc20MintableABI, 'totalSupply', TSelectData>, 'abi' | 'functionName'> = {} as any
) {
 ...
 */
export function useErc20MintableWrite<TMode extends WriteContractMode, TFunctionName extends string>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<TMode, PrepareWriteContractResult<typeof erc20MintableABI, string>['abi'], TFunctionName>
    : UseContractWriteConfig<TMode, typeof erc20MintableABI, TFunctionName> & {
        abi?: never
      } = {} as any
) {
  return useContractWrite<TMode, typeof erc20MintableABI, TFunctionName>({ abi: erc20MintableABI, ...config } as any)
}
...
export function useErc20MintableApprove<TMode extends WriteContractMode>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<TMode, PrepareWriteContractResult<typeof erc20MintableABI, 'approve'>['abi'], 'approve'> & { functionName?: 'approve' }
    : UseContractWriteConfig<TMode, typeof erc20MintableABI, 'approve'> & {
        abi?: never
        functionName?: 'approve'
      } = {} as any
) {
  return useContractWrite<TMode, typeof erc20MintableABI, 'approve'>({ abi: erc20MintableABI, functionName: 'approve', ...config } as any)
}

/**
 * Wraps __{@link useContractWrite}__ with `abi` set to __{@link erc20MintableABI}__ and `functionName` set to `"decreaseAllowance"`.
 */
export function useErc20MintableDecreaseAllowance<TMode extends WriteContractMode>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<TMode, PrepareWriteContractResult<typeof erc20MintableABI, 'decreaseAllowance'>['abi'], 'decreaseAllowance'> & {
        functionName?: 'decreaseAllowance'
      }
    : UseContractWriteConfig<TMode, typeof erc20MintableABI, 'decreaseAllowance'> & {
        abi?: never
        functionName?: 'decreaseAllowance'
      } = {} as any
) {
 ...
 */
export function useErc20MintableIncreaseAllowance<TMode extends WriteContractMode>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<TMode, PrepareWriteContractResult<typeof erc20MintableABI, 'increaseAllowance'>['abi'], 'increaseAllowance'> & {
        functionName?: 'increaseAllowance'
      }
    : UseContractWriteConfig<TMode, typeof erc20MintableABI, 'increaseAllowance'> & {
        abi?: never
        functionName?: 'increaseAllowance'
      } = {} as any
) {
...
export function useErc20MintableMint<TMode extends WriteContractMode>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<TMode, PrepareWriteContractResult<typeof erc20MintableABI, 'mint'>['abi'], 'mint'> & { functionName?: 'mint' }
    : UseContractWriteConfig<TMode, typeof erc20MintableABI, 'mint'> & {
        abi?: never
        functionName?: 'mint'
      } = {} as any
) {
  return useContractWrite<TMode, typeof erc20MintableABI, 'mint'>({ abi: erc20MintableABI, functionName: 'mint', ...config } as any)
}
...
export function useErc20MintableTransfer<TMode extends WriteContractMode>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<TMode, PrepareWriteContractResult<typeof erc20MintableABI, 'transfer'>['abi'], 'transfer'> & {
        functionName?: 'transfer'
      }
  ...
  return useContractWrite<TMode, typeof erc20MintableABI, 'transfer'>({ abi: erc20MintableABI, functionName: 'transfer', ...config } as any)
}
...
export function useErc20MintableTransferFrom<TMode extends WriteContractMode>(
  config: TMode extends 'prepared'
    ? UseContractWriteConfig<TMode, PrepareWriteContractResult<typeof erc20MintableABI, 'transferFrom'>['abi'], 'transferFrom'> & {
        functionName?: 'transferFrom'
      }
  ...
  return useContractWrite<TMode, typeof erc20MintableABI, 'transferFrom'>({ abi: erc20MintableABI, functionName: 'transferFrom', ...config } as any)
}
