...
export function findChain(chains: Chain[], domainId: string): Chain | undefined {
  return chains.find((chain) => chain.domain_id === domainId)
}

export function findAsset(assets: Asset[], transactingAsset: string): Asset | undefined {
...
export function findDecimals(asset: Asset, transactingAsset: string): number | undefined {
