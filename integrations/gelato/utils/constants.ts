...
export const GELATO_CONSTANTS: GelatoConstants = {
  ...
  networks: {
    ...
    42161: {
      ...
      explorerApiKey: process.env.NEXT_PUBLIC_GELATO_SCAN_KEY_ARBITRUM as string,
    },
    43114: {
      graph: 'avalanche',
      ...
      explorerApiKey: process.env.NEXT_PUBLIC_GELATO_SCAN_KEY_AVALANCHE as string,
    },
    56: {
      graph: 'bsc',
      contract: '0x527a819db1eb0e34426297b03bae11F2f8B3A19E',
    ...
    10: {
      ...
      explorerApiKey: process.env.NEXT_PUBLIC_GELATO_SCAN_KEY_OPTIMISM as string,
    },
    1284: {
      graph: 'moonbeam',
      ...
      explorerApiKey: process.env.NEXT_PUBLIC_GELATO_SCAN_KEY_MOONBEAM as string,
    },
    1285: {
      graph: 'moonriver',
      contract: '0x86B7e611194978F556007ac1F52D09d114D8f160',
      ...
      explorerApiKey: process.env.NEXT_PUBLIC_GELATO_SCAN_KEY_MOONRIVER as string,
    },
    80001: {
      testnet: true,
      graph: 'mumbai',
    ...
    421613: {
      ...
      explorerApiKey: process.env.NEXT_PUBLIC_GELATO_SCAN_KEY_ARBITRUM_GOERLI as string,
    },
    5: {
      testnet: true,
      graph: 'goerli',
