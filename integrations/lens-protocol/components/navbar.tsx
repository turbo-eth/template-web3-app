...
export const Navbar = () => {
  ...
  return (
    <nav className="xs:px-6 xs:py-4 flex flex-col items-center justify-between rounded-xl bg-neutral-100 px-8 py-10 dark:bg-stone-900 lg:flex-row">
      ...
      <div className="flex flex-col items-center md:flex-row">
        ...
        <ul className="ml-0 mt-4 flex items-center space-x-6 md:ml-4 md:mt-0">
          <li className="font-semibold">
            <LinkComponent href="/integration/lens-protocol/explore">
              Explore
            </LinkComponent>
          </li>
