  ...
  return (
    <div className="mt-4 w-full border-t-2 pt-4 dark:border-neutral-800">
      ...
      {data?.map((revenue) => {
        ...
        return (
          <div key={asset.address} className="mt-3 flex flex-row items-center justify-center font-mono md:justify-start">
      ...
      {!data?.length && <span className="mt-1 text-xs text-gray-600">None yet</span>}
    </div>
  )
}
