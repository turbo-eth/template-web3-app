    ...
    <>
      <div className="card w-full">
        ...
        <div className="flex items-center justify-between">
          ...
          <p className="text-center text-sm text-gray-500">Proof of Hack recognizes the holder for participating in a Hackathon</p>
        </div>
      </div>
      {isSuccess && (
        <div className="card container mt-10 w-full">
          <div className="flex items-center justify-between">
            <h3 className="text-2xl font-bold">Successfully Created Proof of Hack Credential</h3>
          ...
          <hr className="my-4" />
          <textarea readOnly className="input h-96 dark:text-gray-600 dark:placeholder:text-neutral-400" value={JSON.stringify(data, null, 2)} />
        </div>
      )}
    </>
  )
