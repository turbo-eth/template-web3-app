...
export const OPTIMISM_GOERLI_API_URL = 'https://api-goerli-optimism.etherscan.io/'
...
const {
  ...
  NEXT_PUBLIC_ETHERSCAN_API_KEY_OPTIMISM,
  NEXT_PUBLIC_ETHERSCAN_API_KEY_POLYGON,
  NEXT_PUBLIC_ETHERSCAN_API_KEY_ARBITRUM,
} = env

export const CHAIN_ID_API_KEY_MAP: ChainIdToApi = {
  1: NEXT_PUBLIC_ETHERSCAN_API_KEY,
  2: NEXT_PUBLIC_ETHERSCAN_API_KEY,
  4: NEXT_PUBLIC_ETHERSCAN_API_KEY,
  5: NEXT_PUBLIC_ETHERSCAN_API_KEY,
  42: NEXT_PUBLIC_ETHERSCAN_API_KEY,
  137: NEXT_PUBLIC_ETHERSCAN_API_KEY_POLYGON,
  80001: NEXT_PUBLIC_ETHERSCAN_API_KEY_POLYGON,
  10: NEXT_PUBLIC_ETHERSCAN_API_KEY_OPTIMISM,
  420: NEXT_PUBLIC_ETHERSCAN_API_KEY_OPTIMISM,
  42161: NEXT_PUBLIC_ETHERSCAN_API_KEY_ARBITRUM,
  421613: NEXT_PUBLIC_ETHERSCAN_API_KEY_ARBITRUM,
}
