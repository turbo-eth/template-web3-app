        ...
        <div className="flex-center flex h-full flex-1 flex-col items-center justify-center text-center">
          <motion.div
            ...
            <p className="mt-6 text-center text-sm">
              <LinkComponent className="link" href="https://github.com/turbo-eth/template-web3-app/tree/demo">
                Click here to go-to the <span className="font-bold">demo branch</span> for more integration examples.
              </LinkComponent>
            </p>
          </motion.div>
        </div>
