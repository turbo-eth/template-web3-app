...
export default function PoolTogetherLayout({
  children,
}: {
  children: ReactNode
}) {
    ...
    <>
      <div className="flex-center flex-col items-center justify-center text-center">
        ...
        >
          ...
          <motion.div
            className="mt-8 flex justify-center gap-4 text-2xl sm:gap-6 md:gap-10 lg:gap-14"
            variants={FADE_DOWN_ANIMATION_VARIANTS}
          >
            <LinkComponent
              className={cn(
                "btn hover:opacity-75",
                pathname === depositPath && "opacity-50"
              )}
              href={depositPath}
            >
              Deposit
            ...
            <LinkComponent
              className={cn(
                "btn hover:opacity-75",
                pathname === withdrawPath && "opacity-50"
              )}
              href={withdrawPath}
            >
              Withdraw
