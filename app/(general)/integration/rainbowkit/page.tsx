    ...
    <>
      <div className="flex-center flex flex-1 flex-col items-center justify-center text-center">
        <motion.div
          ...
          <BranchColorMode>
            <Image className="mx-auto" alt="Etherscan logo" src={turboIntegrations.rainbowkit.imgDark} width={100} height={100} />
            <Image className="mx-auto" alt="Etherscan logo" src={turboIntegrations.rainbowkit.imgLight} width={100} height={100} />
          </BranchColorMode>
          <motion.h1
