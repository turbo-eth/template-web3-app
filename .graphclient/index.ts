...
export type LockStats_orderBy = 'id' | 'totalLocksDeployed' | 'totalKeysSold'
...
export type UnlockStats_orderBy = 'id' | 'totalLockDeployed' | 'totalKeysSold' | 'grossNetworkProduct'
...
export type entityDirectiveResolver<Result, Parent, ContextType = MeshContext, Args = entityDirectiveArgs> = DirectiveResolverFn<
  Result,
  Parent,
  ContextType,
  Args
...
export type subgraphIdDirectiveResolver<Result, Parent, ContextType = MeshContext, Args = subgraphIdDirectiveArgs> = DirectiveResolverFn<
  Result,
  Parent,
  ContextType,
  Args
...
export type derivedFromDirectiveResolver<Result, Parent, ContextType = MeshContext, Args = derivedFromDirectiveArgs> = DirectiveResolverFn<
  Result,
  Parent,
  ContextType,
  Args
...
export type LockResolvers<
  ContextType = MeshContext,
  ParentType extends ResolversParentTypes['Lock'] = ResolversParentTypes['Lock']
> = ResolversObject<{
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
...
export type LockStatsResolvers<
  ContextType = MeshContext,
  ParentType extends ResolversParentTypes['LockStats'] = ResolversParentTypes['LockStats']
> = ResolversObject<{
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
...
> = ResolversObject<{
  ...
  unlockDailyData?: Resolver<
    Maybe<ResolversTypes['UnlockDailyData']>,
    ParentType,
    ContextType,
    RequireFields<QueryunlockDailyDataArgs, 'id' | 'subgraphError'>
  >
  unlockDailyDatas?: Resolver<
    Array<ResolversTypes['UnlockDailyData']>,
    ParentType,
    ContextType,
    RequireFields<QueryunlockDailyDatasArgs, 'skip' | 'first' | 'subgraphError'>
  >
  lockStats?: Resolver<
    Array<ResolversTypes['LockStats']>,
    ParentType,
    ContextType,
    RequireFields<QuerylockStatsArgs, 'skip' | 'first' | 'subgraphError'>
  >
  unlockStats?: Resolver<
    Array<ResolversTypes['UnlockStats']>,
    ParentType,
    ContextType,
    RequireFields<QueryunlockStatsArgs, 'skip' | 'first' | 'subgraphError'>
  >
...
> = ResolversObject<{
  lock?: SubscriptionResolver<
    Maybe<ResolversTypes['Lock']>,
    'lock',
    ParentType,
    ContextType,
    RequireFields<SubscriptionlockArgs, 'id' | 'subgraphError'>
  >
  locks?: SubscriptionResolver<
    Array<ResolversTypes['Lock']>,
    'locks',
    ParentType,
    ContextType,
    RequireFields<SubscriptionlocksArgs, 'skip' | 'first' | 'subgraphError'>
  >
  ...
  keys?: SubscriptionResolver<
    Array<ResolversTypes['Key']>,
    'keys',
    ParentType,
    ContextType,
    RequireFields<SubscriptionkeysArgs, 'skip' | 'first' | 'subgraphError'>
  >
  unlockDailyData?: SubscriptionResolver<
    Maybe<ResolversTypes['UnlockDailyData']>,
    'unlockDailyData',
    ParentType,
    ContextType,
    RequireFields<SubscriptionunlockDailyDataArgs, 'id' | 'subgraphError'>
  >
  unlockDailyDatas?: SubscriptionResolver<
    Array<ResolversTypes['UnlockDailyData']>,
    'unlockDailyDatas',
    ParentType,
    ContextType,
    RequireFields<SubscriptionunlockDailyDatasArgs, 'skip' | 'first' | 'subgraphError'>
  >
  lockStats?: SubscriptionResolver<
    Array<ResolversTypes['LockStats']>,
    'lockStats',
    ParentType,
    ContextType,
    RequireFields<SubscriptionlockStatsArgs, 'skip' | 'first' | 'subgraphError'>
  >
  unlockStats?: SubscriptionResolver<
    Array<ResolversTypes['UnlockStats']>,
    'unlockStats',
    ParentType,
    ContextType,
    RequireFields<SubscriptionunlockStatsArgs, 'skip' | 'first' | 'subgraphError'>
  >
  ...
  receipts?: SubscriptionResolver<
    ...
    ParentType,
    ContextType,
    RequireFields<SubscriptionreceiptsArgs, 'skip' | 'first' | 'subgraphError'>
  >
  _meta?: SubscriptionResolver<Maybe<ResolversTypes['_Meta_']>, '_meta', ParentType, ContextType, Partial<Subscription_metaArgs>>
}>

export type UnlockDailyDataResolvers<
  ContextType = MeshContext,
  ParentType extends ResolversParentTypes['UnlockDailyData'] = ResolversParentTypes['UnlockDailyData']
> = ResolversObject<{
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
...
export type UnlockStatsResolvers<
  ContextType = MeshContext,
  ParentType extends ResolversParentTypes['UnlockStats'] = ResolversParentTypes['UnlockStats']
> = ResolversObject<{
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>
  totalLockDeployed?: Resolver<ResolversTypes['BigInt'], ParentType, ContextType>
  totalKeysSold?: Resolver<ResolversTypes['BigInt'], ParentType, ContextType>
...
export type LockStatsQueryQuery = {
  locks: Array<Pick<Lock, 'id' | 'address' | 'name' | 'symbol' | 'totalKeys' | 'maxNumberOfKeys' | 'expirationDuration' | 'price'>>
}
...
export type UserKeysQueryQuery = { keys: Array<Pick<Key, 'id' | 'tokenId' | 'owner'> & { lock: Pick<Lock, 'id' | 'name'> }> }
