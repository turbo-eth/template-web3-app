export const integrations = {
  general: {
    ...
    sessionKeys: {
      ...
      url: "https://viem.sh/",
      description:
        "Short-lied private keys enable transaction signing and the granting of temporary smart contract permissions.",
    ...
    starter: {
      ...
      description:
        "Use ths template to get started building integrations with TurboETH.",
  ...
  protocols: {
    ...
    push_protocol: {
      ...
      url: "https://push.org/",
      description:
        "Push Potocol is a web3 communication network, enabling cross-chain notifications and messaging for dapps, wallets, and services.",
